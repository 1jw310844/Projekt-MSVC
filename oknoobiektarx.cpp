...

{
    ...
    ui->A1->setValue(0.5);
    ui->A2_2->setRange(-1000, 1000);
    ui->A2_2->setValue(0.4);
    ui->A3_2->setRange(-1000, 1000);
    ui->A3_2->setValue(0.3);
    ui->B1_2->setRange(-1000, 1000);
    ui->B1_2->setValue(0.3);
    ui->B2_2->setRange(-1000, 1000);
    ui->B2_2->setValue(0.2);
    ui->B3_2->setRange(-1000, 1000);
    ui->B3_2->setValue(0.1);
    ui->Opoznienie->setRange(0, 1000);
    ui->Opoznienie->setValue(1);
    ui->A1->setSingleStep(0.1);
    ui->A2_2->setSingleStep(0.1);
    ui->A3_2->setSingleStep(0.1);
    ui->B1_2->setSingleStep(0.1);
    ui->B2_2->setSingleStep(0.1);
    ui->B3_2->setSingleStep(0.1);
...
void OknoObiektARX::on_ZatwierdzenieUstawien_accepted()
{
    ...
    obiekt->setWielomianA({ui->A1->value(), ui->A2_2->value(), ui->A3_2->value()});
    obiekt->setWielomianB({ui->B1_2->value(), ui->B2_2->value(), ui->B3_2->value()});
